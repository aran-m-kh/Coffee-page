      ...
      <div className='container sm:pb-0 pb-8'>
        ...
        <div className='grid sm:grid-cols-2 grid-cols-1 justify-center items-center '>
            <div className='order-2 sm:order-1'>
                <h1 className='lg:text-7xl sm:text-6xl text-5xl text-white font-bold'>We serve the richest <span className='text-primary font-cursive'>coffee</span> in the City</h1>
                <button className='bg-gradient-to-r from-primary to-secondary text-white px-3 py-2 mt-8 rounded-full border border-primary hover:scale-105 duration-200'>Coffee and Code</button>
            </div>
        {/* img section */}
            <div className='flex min-h-[450px] items-center justify-center mx-auto order-1 sm:order-2 relative'>
